...
include('./admininclude/header.php'); include('../dbConnection.php');
...
name="stu_occ" value="<?php $row['stu_occ']; }?>"> if(isset($row['stu_occ'])) {echo
</div>
...
<img src="<?php if(isset($row['stu_img'])) { echo $row
['stu_img'); } ?>" alt="" class="img-thumbnail">
<input type="file" class="form-control-file" id="stu_img" name="stu_img">
</div>
<div class="text-center">
<button type="submit" class="btn btn-danger" id="requpdate" name="requpdate">Update</button>
<a href="stu.php" class="btn btn-secondary">Close</a>
</div>
<?php if(isset($msg)) {echo $msg;} ?>
</form>
</div>
